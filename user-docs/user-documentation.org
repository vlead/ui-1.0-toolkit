...
Before you start using the UI 1.0 Toolkit, you need to understand the structure of your lab. Your lab may be either in the Collaborative Framework 
...
As discussed above, your lab may be in either the Collaborative Format (Amrita framework) or unstructured. Depending on the current 
...
*Step 11:* Follow the same procedure for every experiment. After converting all the experiments, rename the "exp1" folder experiment-wise 
