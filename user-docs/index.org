...
The objective of using UI 1.0 Toolkit is to standardize the formats of all labs according to the Virtual-labs UI 1.0 framework. The UI 1.0 Toolkit helps you achieve the following:

- *Unified look and feel:* The UI 1.0 Toolkit offers a uniform user interface for authoring and interacting with the virtual labs. It also provides the labs a simple and uniform web interface and a homogeneous hosting framework.
...
If your lab is structured in Collaborative Format, your lab URL should contain the following fields sub, brch, sim and cnt. For example, the URL of the lab http://iitkgp.vlab.co.in/?sub=39&brch=124&sim=922&cnt=1 is described as below:
...
** Convert Unstructured Labs to UI 1.0 Format
...
*Step 1:* Mention the lab name under =header= and place your experiment name under =article= and replace the content accordingly in each =section= for Aim, Theory and Procedure. Add licensing details and acknowledgements in the footer section.
...
** Convert Labs in Collaborative Framework (Amrita Format) to UI 1.0 Format
...
You need to change the experiment name and add licensing details and acknowledgements in the footer section. 

*Conclusion:* 
This is how your lab structure should be:

[[./images/labs-structure.png]]

The template should be ready with the content. It should resemble the structure below:
