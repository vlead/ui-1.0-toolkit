#+Title: User Documentation on Conversion of a lab to UI 1.0 Template
#+Author: VLEAD
...
(Amrita Format) or may be unstrcutured (does not follow the UI 1.0 Template).
If your lab is structured in Collaborative Format, your lab URL shall contain sub, brch, sim and cnt.
...
* How to Transform your Lab to the UI 1.0 Template?
As discussed above, the strucutre of your lab may be in either the Collaborative Format (Amrita framework) or it may be unstructured. Depending on the current 
structure of your lab, you need to follow the steps below to convert your lab. 
** Transform Unstructured Labs
...
Follow the instructions to transform the default experiment into one experiment of your lab. 
...
*** How to Validate that your lab confirms to UI 1.0 template?
...
*Step 2:* Copy the =scripts= from the path above and paste inside =ui-1.0-toolkit/src/template=.
...
Now the template is ready with content. It should resemble the strcuture below:

Structure of the Lab after Conversion

[[file:images/screenshot2.jpg]]  

** Transform Labs in Collaborator Framework (Amrita Format)
...
You need to change the experiment name and click on it. The template should be ready with the content. It should resemble the strcuture below:
