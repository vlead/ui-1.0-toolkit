...
*Footer* contains the licensing details. The lab developer may add the logo of the institute here. Header and Footer remains the same for all the web pages.
